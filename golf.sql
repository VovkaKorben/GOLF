...
CREATE TABLE `games`  (
  ...
  `mode_id` int(11) NULL DEFAULT NULL,
  `tee_id` int(11) NULL DEFAULT NULL,
  `gender_id` int(11) NULL DEFAULT NULL,
  `comment` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `judge` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `ehcp` decimal(4, 1) NULL DEFAULT NULL,
...
-- Records of games
-- ----------------------------
INSERT INTO `games` VALUES (5, '2025-03-05', 2, 2, 1, 1, 'Great game!', 'Jani Jokelunien', NULL);
INSERT INTO `games` VALUES (6, '2024-03-22', 2, NULL, NULL, NULL, NULL, 'Elon Musk', NULL);
